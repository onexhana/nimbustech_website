      ...
      <div className="w-full">
        <div>
          ...
          <div className="flex flex-col space-y-4">
            {isMobile ? (
              /* 모바일: 한 줄 로고+뱃지+텍스트 */
              <div className="flex items-center justify-center space-x-4" style={{ marginTop: '30px' }}>
                <img src="/logo/logo-white-wide.png" alt="NIMBUS TECH" style={{ width: '180px', height: 'auto' }} />
            ...
            <div className={`text-left ${isMobile ? '' : 'text-left pl-10'}`} style={isMobile ? { margin: '16px 0', marginLeft: '24px' } : { margin: '0 0 0 48px' }}>
              <div className={`${isMobile ? 'space-y-0' : 'space-y-1'}`} style={{ lineHeight: '1.4' }}>
                {/* 주소 및 연락처 */}
                <p style={{ fontSize: isMobile ? '16px' : '18px', color: 'white', margin: '0', marginBottom: isMobile ? '5px' : undefined }}>[세종 본사] 집현중앙7로6, B동 1110호 (세종대명벨리온)</p>
                <p style={{ fontSize: isMobile ? '16px' : '18px', color: 'white', margin: '0', marginBottom: isMobile ? '15px' : undefined }}>[서울사무소] 강남구 선릉로90길 10, B동 407호 (대치동, 샹제리제센터)</p>
                <div style={{ paddingTop: '8px' }}>
                  <div className={`flex ${isMobile ? 'flex-col items-start' : 'items-center justify-between'}`}>
                    <div className={isMobile ? 'mb-4 text-left' : ''}>
                      <p style={{ fontSize: isMobile ? '16px' : '18px', color: 'white', margin: '0', marginBottom: isMobile ? '3px' : undefined }}>T: 02-555-0099</p>
                      <p style={{ fontSize: isMobile ? '16px' : '18px', color: 'white', margin: '0', marginBottom: isMobile ? '5px' : undefined }}>E: nimbustech@nimbustech.co.kr</p>
                    </div>
                    {!isMobile && (
