          ...
          >
            ...
            >
              <span
                ...
                style={isMobile ? {color: '#00A3E0'} : { position: 'relative', zIndex: 1 }}
              >
                인재 채용
              </span>
            </button>
            {isMobile && (
              <>
                ...
                >
                  <span className="relative z-10 text-white">회사소개서 다운로드</span>
                </button>
                <button
                ...
                >
                  <span className="relative z-10">개인정보 처리방침</span>
                </button>
              </>
            )}
          </div>
