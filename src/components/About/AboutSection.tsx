        ...
        */}
        {isMobile ? (
          ...
          <>
            ...
            {/* ======================================== */}
            <div className="flex items-start" style={{ position: 'relative', overflow: 'visible', display: 'flex', alignItems: 'flex-start', gap: '0', justifyContent: 'center', marginLeft: '0', marginRight: '0', maxWidth: '1400px', margin: '0 auto' }}>
