...
export const portfolioProjects = [
  ...
  { id: 3, title: "국가정보자원관리원", description: "범정부 정보자원 통합구축", category: "공공", image: "/portfolio_photo/공공_범정부.jpg" },
  { id: 4, title: "국가정보자원관리원", description: "정보시스템 유지관리 사업", category: "공공", image: "/portfolio_photo/공공_정보시스템.jpg" },
  ...
  { id: 30, title: "국민카드", description: "클라우드 사업", category: "금융", image: "/portfolio_photo/금융_국민카드.jpg" },
  { id: 31, title: "ACE 손해보험", description: "대응개발", category: "금융", image: "/portfolio_photo/금융_ACE.jpg" },
  // 일반 카테고리
  { id: 32, title: "삼성전자", description: "RPA 개발 및 운영사업", category: "일반", image: "/portfolio_photo/.jpg" },
  { id: 33, title: "태평양물산", description: "RPA 시범사업", category: "일반", image: "/portfolio_photo/.jpg" },
  { id: 34, title: "LG", description: "RPA 구축", category: "일반", image: "/portfolio_photo/.jpg" },
  { id: 35, title: "H에너지", description: "태양광 발전 운영시스템 구축", category: "일반", image: "/portfolio_photo/.jpg" },
  { id: 36, title: "CJ", description: "DB 구축 기술지원", category: "일반", image: "/portfolio_photo/.jpg" },
  { id: 37, title: "강원랜드", description: "DBA 운영", category: "일반", image: "/portfolio_photo/.jpg" },
  { id: 38, title: "한국신용정보원", description: "Operator", category: "일반", image: "/portfolio_photo/.jpg" },
  { id: 39, title: "현대백화점", description: "DR구축", category: "일반", image: "/portfolio_photo/.jpg" },
  // 제조 카테고리
